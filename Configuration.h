...
#define STRING_VERSION_CONFIG_H __DATE__ "  3-24-14 " __TIME__ // build date and time
#define STRING_CONFIG_H_AUTHOR "(Maker Farm Inc, 10 i3v Prusa)" //Who made the changes.
...
// default settings 
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80.10386,80.10386,4101.7227,841}
